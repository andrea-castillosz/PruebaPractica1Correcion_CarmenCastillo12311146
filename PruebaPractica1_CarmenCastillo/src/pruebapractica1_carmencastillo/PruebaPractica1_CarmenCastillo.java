...
public class PruebaPractica1_CarmenCastillo {
    ...
    public static void main(String[] args) {
        ...
        while (seguirmenu) {
            System.out.println(" ");
            contadormenu++; //Contador para verificar cuantas veces se usó el Menu Principal
            ...
            System.out.println("");
            if (opcionmenu <= 0) {
                System.out.println("Utilice los numeros que se han dado en el Menu.");
            }
            ...
            switch (opcionmenu) {
                case 1:
                    ...
                    if (repeticion <= 0) {
                        System.out.println("Utilice numeros mayores a 0.");
                    }
